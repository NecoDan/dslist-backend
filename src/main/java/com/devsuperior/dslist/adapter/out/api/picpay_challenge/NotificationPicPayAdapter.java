...
import com.devsuperior.dslist.adapter.out.dto.external.picpay.NotificationDTO;
...
public class NotificationPicPayAdapter implements NotificationPicPayPort {
    ...
    @Override
    public void sendNotification(UserPicPay userPicPay, String message) {

        final var email = userPicPay.getEmail();
