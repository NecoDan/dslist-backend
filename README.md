...
- [H2 Database Memory](https://www.h2database.com/html/main.html)
...
```
git clone https://github.com/NecoDan/dslist-backend.git
```
...
📖 **[MODELAGEM.md](./MODELAGEM.md)** - Documentação Completa de Modelagem
...
para uma vaga backend com perfil júnior. A solução desenvolvida é basicamente uma versão simplificada de eventos transacionais.


--- 
# PicPay Desafio Backend Sênior

Projeto elaborado para solucionar [esse desafio](https://github.com/PicPay/picpay-desafio-backend?tab=readme-ov-file)
para uma vaga backend com perfil sênior. A solução desenvolvida é basicamente uma versão simplificada do PicPay.
